    ...
    <div class="content">
      ...
      <div class="way">
        ...
        <div class="info clearFix">
          ...
          <p>发货时间：预计{{ deliveryTime }} 09:00-17:00发货</p>
        </div>
      </div>
      <div class="detail">
        <h5>商品清单</h5>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee, //最终收件人的名字
        consigneeTel: phoneNum, //最终收件人的手机号
        deliveryAddress: fullAddress, //收件人的地址
