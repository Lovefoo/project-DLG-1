          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="goods in goodsList" :key="goods.id">
                <div class="list-wrap" @click="toDetail(goods.id)">
                  <div class="p-img">
                  ...
                  <div class="attr">
                    <a
                      title="促销信息，下单即赠送三个月ICBM视频会员卡！【小米电视新品4A 58 火爆预约中】"
                      >{{ goods.title }}</a
                    >
                  </div>
                  <div class="commit">
...
export default {
  ...
  methods: {
    ...
    removeCategoryName() {
      ...
      this.getDate();
      //地址栏也需要修改: 进行路由的跳转
      //严谨: 本意是删除query，如果路径当中出现params不应该删除，路由跳转的 时候应该带着
    ...
    //排序的操作
    changeOrder(flag) {
      //flag:它是一个标记，代表用户点击的是综合(1)还是价格(2)
      /* //我的方法
      if(this.searchParams.order.includes(flag)){
  ...
  watch: {
    ...
    $route(newValue, oldValue) {
      //每一次请求完毕，应该把相应的1、2、3级分类的id置空的，让他接受下一次的相应 1、2、3的id
