            ...
            <tr v-for="(cart,index) in order.orderDetailList" :key="cart.id">
              <td width="60%">
                <div class="typographic">
                  <img :src="cart.imgUrl" style="width:100px;height:100px" @click="toDetail(cart.skuId)"/>
                  <a @click="toDetail(cart.skuId)" href="javascript:;" class="block-text">{{cart.skuName}}</a>
              ...
              <td :rowspan="order.orderDetailList.length" v-if="index==0" width="8%" class="center">
                <a class="btn" @click="toPay(cart.orderId)" v-show="order.orderStatusName=='未支付'">{{order.orderStatusName}}</a>
                <a class="btn" v-show="order.orderStatusName=='已支付'">{{order.orderStatusName}}</a>
              </td>
              <td :rowspan="order.orderDetailList.length" v-if="index==0" width="13%" class="center">
                <ul class="unstyled">
                  <li>
